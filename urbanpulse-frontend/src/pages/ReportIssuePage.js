...
function ReportIssuePage() {
  ...
  return (
    <div className="container mt-4">
      ...
      >
        <h2 className="fw-bold">🚨 Report Urban Issue</h2>
        <p className="mb-0">
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          {image && (
            <div className="mb-3">
              <h5 className="mb-3">🖼️ Image Preview</h5>
          ...
          <div className="mb-3">
            <label className="form-label">AI Priority</label>
            ...
            <div>
              ...
              >
                <div className="card-body">
                  <h4 className="fw-bold">📋 Issue Summary</h4>
                  <hr />

                  <p>
                    <strong>Issue Type:</strong> {issueType || "Not Selected"}
                  </p>
                  ...
                  <p>
                    <strong>Priority:</strong> {priority || "Not Detected"}
                  </p>
